...
db.serialize(() => {
    ...
    db.get("SELECT COUNT(*) as count FROM products", (err, row) => {
        if (!err && row.count === 0) {
            const products = [
                ['CR. RONALDO 7 (1гр.) ULTRA M3TH', 'High-quality digital product', 99.99, 'https://via.placeholder.com/300x200/007bff/ffffff?text=Premium'],
                ['АК-47 (5гр.) HIGH QUIALITY', 'Good value for money', 99.99, 'https://via.placeholder.com/300x200/28a745/ffffff?text=Standard'],
                ['ФЛЕКС (1гр) БОЛИВИЯ', 'Essential features', 149.99, 'https://via.placeholder.com/300x200/ffc107/ffffff?text=Basic']
            ];
